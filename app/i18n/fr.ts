const fr = {
  ...
  // Guarantee
  guarantee: {
    title: "Zéro risque. 100% garanti.",
    subtitle: "Nous sommes confiants dans nos agents. Si vous n'êtes pas satisfait dans les 30 jours, on vous rembourse intégralement.",
    badges: [
