        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <div
              ...
              style={{ background: "linear-gradient(135deg, rgba(74,127,255,0.2), rgba(123,63,228,0.2))" }}
            >
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#7B3FE4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
