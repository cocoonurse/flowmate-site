...
const agents = [
  ...
  },
  {
    ...
    status: "bientôt",
    icon: "📊",
    description: "Chaque semaine, recevez automatiquement un rapport complet de votre activité : chiffre d'affaires, devis envoyés, relances à faire.",
    features: ["Rapport PDF automatique", "Synthèse chiffre d'affaires", "Relances clients", "Envoi planifié"],
    demo: null,
  },
  {
    id: "04",
    ...
    status: "bientôt",
    icon: "🧠",
    description: "Le cerveau numérique de votre entreprise. Posez une question sur vos clients, vos devis ou votre historique — MemoAI vous répond instantanément.",
    features: ["Mémoire entreprise", "Recherche intelligente", "Historique clients", "Réponses instantanées"],
    demo: null,
  },
];
